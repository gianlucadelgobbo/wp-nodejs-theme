...
server {
  listen   80;
  listen   [::]:80;
  server_name 79things.dev.flyer.it www.79things.com;
  return 301 https://79things.com$request_uri;
}
...
server {
  ...
  access_log /var/log/nginx/79things.com.access.log;
  error_log /var/log/nginx/79things.com.error.log;
